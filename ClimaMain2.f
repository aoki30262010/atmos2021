...
c             mixing ratio.
!          FI(2,J1-1) = FCO2
                   FI(2,J1-1) = (1. - FI(1,J1-1)) * FCO2init !aoki
                     FLAGCONVEC(J1) = cflag
                   JCONV = J1
           END IF
      END DO
      ...
      ND1 = ND-1
!      DO J=ND1,1,-1
     ! FI(2,J) = AMIN1(FI(2,J),FI(2,J+1))   comment out by aoki
!      END DO
      GO TO 1401
c
...
c-as   it (ND and ND-1) (sept-2004)
     ...
     & Idry, imco2)
       ...
       FI(2,ND-1) = (1. - FI(1,ND-1)) * FCO2init !aoki
...
C-KK To smooth over the profile around JCOLD.
      ...
      FI(1,JCOLD) = sum/5.
      FI(2,JCOLD) = (1.-FI(1,JCOLD)) * FCO2init !aoki
