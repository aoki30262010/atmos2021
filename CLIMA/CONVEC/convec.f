...
c-rr          Putting new curve fit equations 3/29/11
     ...
     &          -3.44E-8*T*T*T  
       ...
       CPCO = 6.1108 + 1.457E-3*T + 9.69E-7*T*T
     &     -6.384E-10*T*T*T+3.13E+4/T/T!Aokic
...
!      CPN2 = FN2P*CPN2 + FO2P*CPO2 + FARP*4.97 + FCH4P*CPCH4 ! New normalized CPN for Co2 moist adiabat
      ...
      CPN = FN2*CPN2 + FO2*CPO2 + FAR*4.97 + FCH4*CPCH4
     &    + FCO*CPCO !Aokic ! This CPN is the total CPN for the noncondensibles only. This CPN is only used for the moist CO2 adiabat (so H2O is not included because it is a condensible. In the moist adiabat, CO2 is a noncondensible).
